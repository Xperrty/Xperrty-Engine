...
namespace Xperrty {
	...
	public:
		...
		inline void resetToOriginalDimensions() { setWidth(static_cast<float>(material->getTexture()->getWidth())); setHeight(static_cast<float>(material->getTexture()->getHeight())); }
